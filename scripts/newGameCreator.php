...
');
	...
	if($game == "Scrabble") {
		...
		mkdir("../session/" . $_POST["newGameId"] . "/position");
	          
		// Create playerStatus folder
	
		mkdir("../session/" . $_POST["newGameId"] . "/playerStatus");
		
		// Create usercodes folder
	
		mkdir("../session/" . $_POST["newGameId"] . "/usercodes");
		...
		// create check type file
		
		$checkTypeFile = "../session/" . $_POST["newGameId"] . "/checkType.txt";
	
		// create usercode File
	          
		$usercodeFile = "../session/" . $_POST["newGameId"] . "/usercodes/" . $_POST["userVariable"] . ".txt";
		
		file_put_contents($checkTypeFile, $_POST["whotCheckType"]);
