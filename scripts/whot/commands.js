// function to check for and execute commands 
	...
	$.ajax({
		...
		cache: false
			...
			// send whot requester index through AJAX
	...
	$.ajax({
		...
		data: {
			gameFolder: sessionStorage.getItem("gameStatus"),
			request: "updateWhotRequesterIndex",
			index: participantsArray.indexOf(localStorage.getItem("scrabblitUsername"))
		},
		cache: false
	});
