$(document).ready(function() {
	...
	function loadWhotBoard() {
		...
		$("body").html('<div class="header">  <img src="../images/whot/logo.jpg" id="logo"></img>  <label class="heading">Whot</label>  <div id="refresh" class="headIcon"> <img src="../images/refresh.jpg" id="btnRefresh"></img> </div>  <a href="../join-game"> <img src="../images/home.png" class="headIcon" id="homeIcon"></img> </a>  <a href="../join-game?stage=dashboard"> <img src="../images/icons/dashboard.jpg" class="headIcon" id="dashboardIcon"></img> </a>  <div id="secondHeader"> <div id="participantsBar"></div> </div> </div> <br><br><br><br><br><br><br><br><br><br><br><br><br>  <div id="finalPosition"> <div id="finalPositionColumn1"> </div> <div id="finalPositionColumn2"></div> </div>       <div id="myCards"></div><div id="othersCardsHolder"></div> <div id="cardStack"></div> <div id="market"></div> <div id="whotShapesHolder"> <button class="whotShapesSelectors" id="Carpet"> <label class="Carpet"></label> </button>  <button class="whotShapesSelectors" id="Ball"> <label class="Ball"></label> </button>  <button class="whotShapesSelectors" id="Star"> <label class="Star"></label> </button>  <button class="whotShapesSelectors" id="Angle"> <label class="Angle"></label> </button> <button class="whotShapesSelectors" id="Cross"> <label class="Cross"></label> </button> </div> <label id="remark"></label>  <label id="gameStatus"></label>            <p class="hidden" id="gameStatus"></p> <p class="hidden" id="currentPlayer"></p> <p class="hidden" id="successivePlayerClearer"></p> <p class="hidden" id="otherCardsLooper"></p> <p class="hidden" id="hiddenCardStack"></p> <p class="hidden" id="marketEligibility"></p>  <p class="hidden" id="firstPlayChecker"> </p>  <p class="hidden" id="cardSelectionIndex"> </p> <p class="hidden" id="command"> </p>  <p class="hidden" id="hiddenCards"> </p> <p class="hidden" id="command"> </p>  <p class="hidden" id="threePicker"> </p> <p class="hidden" id="pickThreeStatus"> </p> <p class="hidden" id="holdOnChecker"> </p> <p class="hidden" id="whotCommandChecker"> </p> <p class="hidden" id="whotShapeChecker"> </p> <p class="hidden" id="whotRequesterIndex"> </p> <p class="hidden" id="currentCommand"> </p>  <p class="hidden" id="checkType"> </p>   <p class="hidden" id="position"> </p>  <p class="hidden" id="positionHolder"> </p>  <p class="hidden" id="cardsHolder"> </p> <p class="hidden" id="hasRepeated"></p> <p class="hidden" id="participantsUsercode"></p>   '); 
		
		$("head").append('<script src="../scripts/methods.js"></script>  <script src="../scripts/whot/index.js"></script> <script src="../scripts/whot/variable.js"></script>  <script src="../scripts/whot/gameController.js"></script> <script src="../scripts/whot/methods.js"></script> <script src="../scripts/whot/commands.js"></script> <script src="../scripts/whot/positionAwarder.js"></script>  ');
